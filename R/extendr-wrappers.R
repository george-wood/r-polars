...
date_range <- function(start, end, every, closed, time_unit, time_zone) .Call(wrap__date_range, start, end, every, closed, time_unit, time_zone)

date_ranges <- function(start, end, every, closed, time_unit, time_zone) .Call(wrap__date_ranges, start, end, every, closed, time_unit, time_zone)
